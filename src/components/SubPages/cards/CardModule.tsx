...
export default function CardModule({
  ...
  return (
    <Link to={"/Cards/CardDetails"} className= " flex !text-white !bg-black flex-col min-w-[300px] h-[200px] rounded-lg shadow-xl border-none  hover:border-black border cursor-pointer hover:shadow-2xl hover:scale-105  transition-transform ease-in-out " style={{backgroundColor : cardColor,color:textColor}}>
